-- CreateEnum
CREATE TYPE "public"."Permission" AS ENUM ('ADMIN_ACCESS', 'ADMIN_USERS_VIEW', 'ADMIN_USERS_SEARCH', 'ADMIN_USERS_EDIT', 'ADMIN_USERS_DELETE', 'ADMIN_USERS_IMPERSONATE', 'ADMIN_DEBUG');
